...
def create_template():
    ...
    fig = go.Figure(layout={'hoverlabel':{'bgcolor': '#ffffff', 'font':{'size':16}},'font': {'family':'Montserrat', 'color': '#898989'},'paper_bgcolor': '#ebf2fa','plot_bgcolor': '#ebf2fa','template':'simple_white' })
